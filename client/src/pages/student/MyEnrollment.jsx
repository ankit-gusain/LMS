...
const MyEnrollment = () => {
  ...
  const [progressArray, setProgressArray] = useState([
    ...
    { lectureCompleted: 1, totalLectures: 16 },
  ...
  return (
    <>
      <div className="md:px-36 px-8 pt-10 mb-60 ">
              ...
              enrolledCourses.map((course, index) => (
                <tr key={index} className="border-b border-gray-200">
                  <td className="md:px-4 pt-2 md:pl-4 py-3 flex items-center space-x-3">
                    <img src={course.courseThumbnail} alt="" className="w-14 sm:w-14 md:w-28" />
                  ...
                  <td className="px-4 py-3 max-sm:right ">
                    <button
                      ...
                      className="px-3 sm:px-5 py-1.5 sm:py-2 bg-green-800 max-sm:text-xs text-white">
                      {
